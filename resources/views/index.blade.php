...
$isVideo = preg_match('/\.(mp4|webm|ogg|avi|mov)$/i', $filePath);
                        ...
                        <div class="slider-home1 relative overflow-hidden swiper-slide">
                            <div class="silider-image">
                                @if ($isVideo)
                                    <video src="{{ $src }}" class="image-slide" autoplay muted loop playsinline
                                        alt="Video slider" width="100%"></video>
                                @else
                                    {{-- <img src="{{ $src }}" class="image-slider-home2 relative" alt="Image slider"> --}}
                                    <img src="{{ $src }}" alt="Image" class="image-slide">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8">
                                            ...
                                            <h1 class="title-slide text-white mb-32 fadeInDown wow">
                                                ...
                                                <span class="animationtext clip text-main">
                                                    <span class="cd-words-wrapper">
                                                        <span
                                                            class="item-text is-visible">{{ $home->animation_word_of_banner }}</span>
                                                        <span
                                                            class="item-text is-hidden">{{ $home->animation_word_of_banner }}</span>
                                                    </span>
                                                </span>
                                            </h1>
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <a href="{{ route('about-us') }}" class="btn-w-wa fadeInDown wow">
                ...
                <div class="row">
                    <div class="col-lg-12 center relative z-index3">
                        ...
                        <span class="sub-title text-main font-yes fs-28-46 wow fadeInUp animated">Explore
                            the world</span>
                        <h1 class="banner-text title-slide text-white mb-45 wow fadeInUp animated">
                            {{ $home->header_text }}
    ...
    <!-- Widget destination -->
    <section class="widget-destination" style="margin-top: 10rem">
        <div class="tf-container">
            <div class="row">
                <div class="col-lg-12">
                ...
                @foreach ($home->summary_of_places ?? [] as $place)
                    @foreach ($place['images'] ?? [] as $image)
                        ...
                        <div class="tf-widget-destination wow fadeInUp animated " data-wow-delay="0.1s">
                            <a href="#" class="destination-imgae" style="height: 80%">
                            ...
                            <div class="destination-content">
                                ...
                                <div class="flex-two btn-destination">
                                    <h6 class="title"><a href="#">View all tours</a></h6>
    ...
    <section class="widget-banner-contact relative" style="margin-top: 10rem">
        <div class="tf-container">
            <div class="row z-index3 relative">
    ...
    <!-- Widget Counter -->
    <section class="widget-counter relative" style="margin-top:10rem;margin-bottom:10rem;">
            ...
            <div class="row mb--20em relative z-index3">
                <div class="col-6 col-lg-3 wow fadeInUp animated " data-wow-delay="0.1s">
                    <div class="tf-counter center tf-countto">
                        ...
                        <div class="number-counter " data-to="5489" data-speed="2000" data-waypoint-active="yes">5489
                        </div>
                ...
                <div class="col-md-7">
                    <div class="">
                        <span class="sub-title-heading text-main fs-28-46 font-yes wow fadeInUp animated">Explore
                            the world</span>
                        <h2 class="title-heading wow fadeInUp animated">Summary of Services
                            <br><span class="text-gray font-yes">adventure</span>
                        </h2>
                    </div>
                </div>
                <div class="col-md-5">
                            ...
                            @foreach ($home->summary_of_services ?? [] as $service)
                                <div class="swiper-slide">
                                    <div class="tf-icon-box icon-box-style1 relative"
                                        style="height: 400px; display: flex; flex-direction: column; justify-content: space-between;  box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
                                        ...
                                        <div class="content" style="display: flex; flex-direction: column; height: 100%;">
                                            <h4 class="title-icon" style="margin: 0 0 10px 0;">
                                                <a href="#" style="">
                                                    {{ $service['title'] }}
                                                </a>
                                            </h4>
                                            <p class="des-icon" style="flex-grow: 1; margin-bottom: 10px;">
                                            <p class="des-icon" style="flex-grow: 1; margin-bottom: 10px;">
                                                {{ \Illuminate\Support\Str::words($service['description'], 50, '...') }}
                                                {{-- {{ \Illuminate\Support\Str::limit($service['description'], 100, '...') }} --}}

                                            </p>

                                            </p>
                                            <a href="#" class="icons-link" style="margin-top: auto;">
                                                {{ $service['link_text'] ?? 'Booking Now' }}
