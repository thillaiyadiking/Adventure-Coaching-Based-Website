...
@section('content')
            ...
            <div class="row">
                <div class="col-md-4 wow fadeInUp animated " data-wow-delay="0.1s">
                    <div class="banner-part-item booking-style-1 relative bg-part-gray overflow-hidden">
                        ...
                        <img src="assets/images/explore/mask-banner-part.png" alt="image" class="mask-banner-bottom">
                    </div>
                </div>
                <div class="col-md-4 wow fadeInUp animated " data-wow-delay="0.2s">
                    <div class="banner-part-item booking-style-2 relative bg-part-gray overflow-hidden">
                        <div class="content relative z-index3">
                            ...
                            <a href="#" class="tour1 btn-booking ">Booking Now <i class="icon-arrow-right"></i></a>
                        </div>

                        <img src="assets/images/explore/ex-pl2.jpg" alt="image" class="mask-banner-part">
                        <img src="assets/images/explore/shape1.png" alt="image" class="banner-part-shape1">
                        <img src="assets/images/explore/shape2.png" alt="image" class="banner-part-shape2">
                        <img src="assets/images/explore/mask-banner-part.png" alt="image" class="mask-banner-bottom">
                ...
                <div class="col-md-4 wow fadeInUp animated " data-wow-delay="0.3s">
                    <div class="banner-part-item booking-style-3 relative bg-part-blue overflow-hidden">
                        ...
                        <img src="assets/images/explore/shape3.png" alt="image" class="banner-part-shape1">
                        <img src="assets/images/explore/mask-banner-part.png" alt="image" class="mask-banner-bottom">
                    </div>
                </div>
            </div>
    ...
    <section class="about-us-h2 pd-main relative">
        <img src="assets/images/page/mask-ex.png" alt="image" class="mask1-about">
        <img src="assets/images/page/fly4.png" alt="image" class="mask2-about">
        <div class="tf-container">
            <div class="row">
                <div class="col-md-6">
                    <div class="image-about-us relative">
                        <img src="assets/images/page/vector3.png" alt="image" class="mask1">
                        <img src="assets/images/page/fly3.png" alt="image" class="mask2">
                        <img src="assets/images/about-us/ewewe2.png" alt="image" class="image-main">
                    </div>
                </div>
                <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="icon-box-style-4 flex">
                                    <div class="icon flex-five">
                                        <svg width="33" height="33" viewBox="0 0 33 33" fill="none"
                                            ...
                                            <mask id="mask0_95_95" style="mask-type:luminance" maskUnits="userSpaceOnUse"
                                    ...
                                    <div class="content">
                                        <h6 class="title mb-15 wow fadeInUp animated"><a href="#">Safety first
                                                always</a>
                                        </h6>
                                ...
                                <div class="icon-box-style-4 flex">
                                    ...
                                    <div class="content">
                                        <h6 class="title mb-15 wow fadeInUp animated"><a href="#">Trusted travel
                                                guide</a>
                                        </h6>
                                        <p class="des wow fadeInUp animated">Welcome to our Print 128 web
                                            company that offers a wide </p>
                ...
                <div class="col-md-7">
                    <div class="right-side">
                        <div class="image-activities mb-10">
                            <img src="assets/images/page/explore.jpg" alt="">
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                                ...
                                                <div class="icons flex-three">
                                                    <svg width="21" height="16" viewBox="0 0 21 16"
                                                        ...
                                                        <path
                                                            ...
                                                            stroke-miterlimit="10" stroke-linecap="round"
                                                            stroke-linejoin="round" />
                                                        <path d="M17.1035 15.1797V9.02734" stroke="#004F8A"
                                                            stroke-width="1.7" stroke-miterlimit="10"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path d="M20.1797 12.1035H14.0273" stroke="#004F8A"
                                                            stroke-width="1.7" stroke-miterlimit="10"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                    </svg>
                                                    <span>12 Person</span>
                                            ...
                                            <div class="icon-box flex-three">
                                                ...
                                                <div class="icons flex-three">
                                                    <svg width="21" height="16" viewBox="0 0 21 16"
                                                        ...
                                                        <path
                                                            d="M4.34766 4.79761C4.34766 2.94013 5.85346 1.43433 7.71094 1.43433C9.56841 1.43433 11.0742 2.94013 11.0742 4.79761C11.0742 6.65508 9.56841 8.16089 7.71094 8.16089C5.85346 8.16089 4.34766 6.65508 4.34766 4.79761Z"
                                                            stroke="#004F8A" stroke-width="1.7" stroke-miterlimit="10"
                                                            stroke-linecap="round" stroke-linejoin="round" />
                                                        <path
                                                            d="M9.5977 15.1797H2.46098C1.34827 15.1797 0.558268 14.0954 0.898984 13.0362C1.80408 10.222 4.57804 8.18566 7.69301 8.18566C9.17897 8.18566 10.5566 8.64906 11.6895 9.43922"
                                                            stroke="#004F8A" stroke-width="1.7" stroke-miterlimit="10"
    ...
    <section class="widget-destination1 pd-main relative">
        <img src="assets/images/page/shape2.png" alt="image" class="shape-destination">
        <div class="tf-container">
            ...
            <div class="destination-grid z-index3 relative">
                ...
                <div class="destination-tour center wow fadeInUp animated " data-wow-delay="0.2s">
                    <a href="tour-destination-v2.html" class="destination-image">
                        <img src="assets/images/tour/tour5.1.jpg" alt="">
                    </a>
                    <div class="destination-tour-list">
                        <div class="tour2">
                            <svg width="91" height="32" viewBox="0 0 91 32" fill="none"
                ...
                <div class="destination-tour center wow fadeInUp animated " data-wow-delay="0.3s">
                    <a href="tour-destination-v3.html" class="destination-image">
                        <img src="assets/images/tour/tour5.2.jpg" alt="">
                    </a>
                    <div class="destination-tour-list">
                        <div class="tour3">
                            <svg width="91" height="32" viewBox="0 0 91 32" fill="none"
                ...
                <div class="destination-tour center wow fadeInUp animated " data-wow-delay="0.5s">
                    <a href="tour-destination-v3.html" class="destination-image">
                        <img src="assets/images/tour/tour5.4.jpg" alt="">
                    </a>
                    <div class="destination-tour-list">
                        <div class="tour5 ">
                            <svg width="91" height="32" viewBox="0 0 91 32" fill="none"
                ...
                <div class="destination-tour center wow fadeInUp animated " data-wow-delay="0.6s">
                    <a href="tour-destination-v3.html" class="destination-image">
                        <img src="assets/images/tour/tour5.5.jpg" alt="">
                    </a>
                    <div class="destination-tour-list">
                        <div class="tour6">
                            <svg width="91" height="32" viewBox="0 0 91 32" fill="none"
                ...
                <div class="col-md-5">
                    <div class="image-feature-wrap relative ">
                        <div class="image-feature relative overflow-hidden">
                            <img src="assets/images/page/explore2.jpg" alt="image" class="image">
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <div class="widget-testimonial-style2 relative">
                                    ...
                                    <img src="assets/images/testimonial/mask.png" class="mask-tes" alt="Mask">
                                </div>
                            </div>
                            <div class="swiper-slide">
                                <div class="widget-testimonial-style2 relative">
                ...
                <div class="col-md-4 wow fadeInUp animated " data-wow-delay="0.1s">
                    <div class="tf-widget-blog blog-style1 mb-30">
                        ...
                        <div class="blog-content center">
                            ...
                            <a href="blog-details.html" class="icon-link flex-five"><i class="icon-Vector-3"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 wow fadeInUp animated " data-wow-delay="0.2s">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mobie-app-image relative">
                            ...
                            <div class="flex-three mobie-wrap wow fadeInUp animated">
                                <a href="#"><img src="assets/images/page/apple.png" alt="image"></a>
                                <a href="#"><img src="assets/images/page/adroid.png" alt="image"></a>
                            </div>
                            <div class="qr-code">
                    ...
                    <div class="col-md-6">
                        <div class="mobie-app-content relative text-end">
                            <img src="assets/images/page/mask-mobie.png" alt="image" class="mask-mobie">
                            <img src="assets/images/page/phone.png" alt="image" class="phone">
                        </div>
                    </div>
                </div>
            </div>
